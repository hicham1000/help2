...
class ContextController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('context_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('context/new.html.twig', [
            'context' => $context,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Context $context): Response
    {
        ...
        return $this->renderForm('context/edit.html.twig', [
            'context' => $context,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="context_delete", methods={"POST"})
     */
